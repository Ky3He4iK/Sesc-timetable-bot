...
class TTDay:
    ...
    class TTLesson:
        ...
        class TTLClass:
            def __init__(self):
                self.group = [self.TTCell() for _ in range(0)]  # array of lessons
...
class FreeRoomsAll:
    ...
    def __dict__(self):
        return {'all': [a.__dict__() for a in self.all]}
    ...
    class FreeRoomsDay:
        ...
        class FreeRoomsLesson:
            def __init__(self):
                self.lesson = ['' for _ in range(0)]  # array of string

            def __dict__(self):
                return {'lesson': self.lesson}
        ...
        def restore(self, original):
            self.day = [self.FreeRoomsLesson().restore(origin) for origin in original['day']]
            return self
